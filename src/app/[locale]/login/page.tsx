...
export default function LoginPage() {
  ...
  console.log("➡️ [LoginPage] Rendering. isAuthenticated:", isAuthenticated, "isLoading:", isLoading, "currentUser:", !!currentUser);

  useEffect(() => {
    console.log("➡️ [LoginPage] useEffect triggered. isLoading:", isLoading, "isAuthenticated:", isAuthenticated);
